...
export function activate(context: ExtensionContext) {
    ...
    const i18nGenerator = new I18nGenerator(workspaceFolder, new FileSystem(), new UserActions(window));
    ...
    subscriptions.push(commands.registerCommand("flutterI18nYTranslateApiCodeAdd", () => {
        i18nGenerator.generateYTranslateApiCodeAdd();
    }));

    subscriptions.push(commands.registerCommand("flutterI18nAutoGTranslate", () => {
        i18nGenerator.generateGTranslationsAsync();
    }));

    subscriptions.push(commands.registerCommand("flutterI18nAutoYTranslate", () => {
        i18nGenerator.generateYTranslationsAsync();
    }));
